...
const Contact = () => {
  return (
    <section className="relative py-8 pt-28 ">
      <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 bg-white rounded-lg shadow-2xl overflow-hidden">
      ...
      <div className="flex justify-center mt-12 rounded-lg">
        <iframe
          ...
          className="w-[75%] h-96 rounded-lg shadow-lg"
          allowFullScreen=""
          loading="lazy"
